...
class MeusEsdevenimentsRecyclerViewAdapter : RecyclerView.Adapter<MeusEsdevenimentsRecyclerViewAdapter.ViewHolder>() {

    private val eventTitles = arrayOf("Mitja Marató de Barcelona")
    private val eventDates = arrayOf("17/10/2021, 10:00")
    private val eventParticipants = arrayOf("650/8000")
    private val eventUbications = arrayOf("Barcelona")
    private val eventImages = arrayOf(R.drawable.runnning_event)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        //val createEvent = CreateEventActivity(getContext())
